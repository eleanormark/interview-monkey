...
describe('Nesting records', function(){
    ...
    it('Creates an interviewer with sub-documents', function(done){
        ...
        interviewer.save().then(function(){
            newSurvey.save().then(function(){
                Interviewer.update({userName: 'Monkey007'}, {$push: { surveys: newSurvey._id }}).then(function(){
    ...
    it('Add response to a survey', function(done){
        ...
        newSurvey.responses.push({answer: "buzz buzz buzz", questionID: newSurvey.questions[0]._id});
